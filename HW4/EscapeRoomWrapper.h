...
namespace escaperoom {
    ...
    public:
        ...
        /**
         * a function that adds a new enigma to the EscapeRoom.
         * @param enigma - the engima to add.
         */
        void addEnigma(const Enigma& enigma);
        /**
         * a function that removes an anigma from an EscapeRoom.
         * @param enigma
         */
        void removeEnigma(const Enigma& enigma);
        /**
         * a getter that returns the hardest enigma in the room.
         * @return the hardest enigma in the room.
         */
        Enigma getHardestEnigma();
        /**
         * a getter that returns a reference to a vector that contains all of
         * the enigmas.
         * @return a reference to a vector that contains all of the enigmas.
         */
     ...
     * @param room - the EscapeRoom to print the data on.
